...
class ChangeOABApp(tk.Tk):
    ...
    def create_canvas(self):
        ...
        background_image = PhotoImage(
            file=self.relative_to_assets('mudar_oab_image_1.png')
        )
        ...
        second_image = PhotoImage(
            file=self.relative_to_assets('mudar_oab_image_2.png')
        )
    ...
    def create_entries(self):
        self.entry_new_oab = self.create_entry(
            295.0, 274.0, 418.0, 45.0, 'OAB:'
        )
        from .app import App

        self.entry_new_oab.insert(0, App.load_user_state()['oab'])

    def create_entry(self, x, y, width, height, label_text):
        entry_image = PhotoImage(
            file=self.relative_to_assets('mudar_oab_entry_1.png')
        )
